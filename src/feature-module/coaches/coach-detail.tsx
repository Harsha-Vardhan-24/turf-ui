            ...
            <div className="col-12 col-sm-12 col-md-12 col-lg-8">
              ...
              <div className="venue-options white-bg mb-4">
                <ul className="clearfix">
                  <li className="active">
                    <Link  onClick={() => scrollContent("short-bio")}>Short Bio</Link>
                  </li>
                  <li>
                    <Link onClick={() => scrollContent("basic-info")}>Lesson With Me</Link>
                  </li>
                  <li>
                    <Link onClick={() => scrollContent("coaching")}>Coaching</Link>
                  </li>
                  <li>
                    <Link  onClick={() => scrollContent("gallery")}>Gallery</Link>
                  </li>
                  <li>
                    <Link onClick={() => scrollContent("reviews")}>Reviews</Link>
                  </li>
                  <li>
                    <Link  onClick={() => scrollContent("location")}>Locations</Link>
                  </li>
                </ul>
              </div>
              {/* Accordian Contents */}
