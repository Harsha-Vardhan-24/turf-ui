    ...
    <Slider {...images} className="venue-space">
      <div className="gallery-widget-item">
        <Link to="#" data-fancybox="gallery1">
          <ImageWithBasePath className="img-fluid" alt="Image" src="assets/img/gallery/gallery1/gallery-01.png" />
        </Link>
      </div>	
      <div className="gallery-widget-item">
        <Link to="#" data-fancybox="gallery1">
          <ImageWithBasePath className="img-fluid" alt="Image" src="assets/img/gallery/gallery1/gallery-02.png" />
        </Link>
      </div>								
      <div className="gallery-widget-item">
        <Link to="#" data-fancybox="gallery1">
          <ImageWithBasePath className="img-fluid" alt="Image" src="assets/img/gallery/gallery1/gallery-03.png" />
        </Link>
      </div>	
      <div className="gallery-widget-item">
        <Link to="#" data-fancybox="gallery1">
          <ImageWithBasePath className="img-fluid" alt="Image" src="assets/img/gallery/gallery1/gallery-04.png" />
        </Link>
      </div>
      <div className="gallery-widget-item">
        <Link to="#" data-fancybox="gallery1">
          <ImageWithBasePath className="img-fluid" alt="Image" src="assets/img/gallery/gallery1/gallery-05.png" />
        </Link>
      </div>
      <div className="gallery-widget-item">
        <Link to="#" data-fancybox="gallery1">
              ...
              <div id="panelsStayOpen-collapseFive" className="accordion-collapse collapse show" aria-labelledby="panelsStayOpen-gallery">
                <div className="accordion-body">
                  ...
                  <Slider {...settings}>
                    ...
                    <Link className="corner-radius-10" to="#" data-fancybox="gallery3">
                      <ImageWithBasePath className="img-fluid corner-radius-10" alt="Image" src="assets/img/gallery/gallery2/gallery-01.jpg" />
                    </Link>
                    <Link className="corner-radius-10" to="#" data-fancybox="gallery3">
                      <ImageWithBasePath className="img-fluid corner-radius-10" alt="Image" src="assets/img/gallery/gallery2/gallery-02.jpg" />
                    </Link>
                    <Link className="corner-radius-10" to="#" data-fancybox="gallery3">
                      <ImageWithBasePath className="img-fluid corner-radius-10" alt="Image" src="assets/img/gallery/gallery2/gallery-03.jpg" />
                    </Link>
                    <Link className="corner-radius-10" to="#" data-fancybox="gallery3">
                      <ImageWithBasePath className="img-fluid corner-radius-10" alt="Image" src="assets/img/gallery/gallery2/gallery-01.jpg" />
                    </Link>
                  ...
                  <div className="review-box d-md-flex">
                    ...
                    <div className="review-info">
                      ...
                      <ul className="review-gallery clearfix">
                        <li>
                          <Link to="assets/img/gallery/gallery-thumb-01.jpg" data-fancybox="gallery">
                            <ImageWithBasePath className="img-fluid" alt="Image" src="assets/img/gallery/gallery-01.jpg" />
                          </Link>
                        </li>
                        <li>
                          <Link to="assets/img/gallery/gallery-thumb-02.jpg" data-fancybox="gallery">
                            <ImageWithBasePath className="img-fluid" alt="Image" src="assets/img/gallery/gallery-02.jpg" />
                          </Link>
                        </li>
                        <li>
                          <Link to="assets/img/gallery/gallery-thumb-03.jpg" data-fancybox="gallery">
                            <ImageWithBasePath className="img-fluid" alt="Image" src="assets/img/gallery/gallery-03.jpg" />
                          </Link>
                        </li>
                        <li>
                          <Link to="assets/img/gallery/gallery-thumb-04.jpg" data-fancybox="gallery">
                            <ImageWithBasePath className="img-fluid" alt="Image" src="assets/img/gallery/gallery-04.jpg" />
                          </Link>
                        </li>
                        <li>
                          <Link to="assets/img/gallery/gallery-thumb-05.jpg" data-fancybox="gallery">
                            <ImageWithBasePath className="img-fluid" alt="Image" src="assets/img/gallery/gallery-05.jpg" />
                          </Link>
                        </li>
                      </ul>
...
<div className="stickybar">       
          ...
          <div className="white-bg book-court">
            ...
            <div className="d-grid btn-block mt-3">
              <Link to="coach-details.html" className="btn btn-secondary d-inline-flex justify-content-center align-items-center"><i className="feather-calendar" />Book Now</Link>
            </div>
          </div>
          ...
          <div className="white-bg cage-owner-info">
            ...
            <div className="d-grid btn-block text-center mt-3">
              <Link to="contact-us.html" className="btn btn-secondary d-inline-flex justify-content-center align-items-center"><i className="feather-phone-call" />Call Owner</Link>
            </div>
          </div>
          <div className="white-bg listing-owner">
            ...
            <ul>
              <li className="d-flex justify-content-start align-items-center">
                <div >
                  <Link to="blog-details.html"><ImageWithBasePath className="img-fluid" alt="Venue" src="assets/img/listing-by-owner-01.jpg" /></Link>
                </div>
                <div className="owner-info">
                  <h5><Link to="blog-details.html">Manchester Academy</Link></h5>
              ...
              <li className="d-flex justify-content-start align-items-center">
                <div >
                  <Link to="blog-details.html"><ImageWithBasePath className="img-fluid" alt="Venue" src="assets/img/listing-by-owner-02.jpg" /></Link>
                </div>
                <div className="owner-info">
                  <h5><Link to="blog-details.html">Sarah Sports Academy</Link></h5>
                  <p><i className="feather-map-pin" /><span>Sacramento, CA</span></p>
                  <p className="mb-0"><i className="feather-calendar" /><span>Next Availablity : </span><span className="primary-text">15 May 2023</span></p>
                </div>
              </li>
              ...
              <div className="listing-item mb-0">										
                ...
                <div className="listing-content">
                  ...
                  <h3 className="listing-title">
                    <Link to="venue-details.html">Sarah Sports Academy</Link>
                  </h3>
                  ...
                  <div className="listing-button">
                    ...
                    <Link to="venue-details.html" className="user-book-now"><span><i className="feather-calendar me-2" /></span>Book Now</Link>
                  </div>	
                </div>
              </div>
            </div>
            ...
            <div className="featured-venues-item">
              <div className="listing-item mb-0">										
                ...
                <div className="listing-content">
                  ...
                  <h3 className="listing-title">
                    <Link to="venue-details.html">Manchester Academy</Link>
                  </h3>
                  <div className="listing-details-group">
            ...
            <div className="featured-venues-item">
              <div className="listing-item mb-0">										
                ...
                <div className="listing-content">
                  ...
                  <h3 className="listing-title">
                    <Link to="venue-details.html">ABC Sports Academy</Link>
                  </h3>
                  <div className="listing-details-group">
