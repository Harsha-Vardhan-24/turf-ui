...
const EditCourt = () => {
  ...
  useEffect(() => {
    if (adminId && courtId) {
      const getCourtData = async () => {
        ...
        const timeSlots = response.data.courts[0].time_Slots;

        // Create an updated selectedHours object by mapping the array to the days of the week
        const updatedSelectedHours = timeSlots.reduce(
          ...
          { ...selectedHours }
        ); // Use the current state as the initial value

        const fetchedCourtData = response.data.courts[0];
        const fetchedImages = [];

        setCourtData(fetchedCourtData);
        setSelectedHours(updatedSelectedHours); // Update selectedHours with the mapped object

        for (const image of fetchedCourtData.images) {
        ...
        reset({
          ...
          courtIncludes: {
            badmintonRacket: fetchedCourtData.includesData.badminton_racket,
            bats: fetchedCourtData.includesData.bats,
            hittingMachines: fetchedCourtData.includesData.hitting_machines,
            multipleCourts: fetchedCourtData.includesData.multiple_courts,
            sparePlayers: fetchedCourtData.includesData.spare_players,
            instantRacket: fetchedCourtData.includesData.instant_racket,
            greenTurfs: fetchedCourtData.includesData.green_turfs,
          },
          rulesOfVenue: fetchedCourtData.rules_of_venue,
          amenities: {
            parking: fetchedCourtData.amenitiesData.parking,
            drinkingWater: fetchedCourtData.amenitiesData.drinking_water,
            firstAid: fetchedCourtData.amenitiesData.first_aid,
            changeRoom: fetchedCourtData.amenitiesData.change_room,
            shower: fetchedCourtData.amenitiesData.shower,
          },
          location: {
        ...
        const daysData = timeSlots.map(({ duration }: any) => {
          return duration !== ""; // Return true if duration is not empty, otherwise false
        });
  ...
  const onSubmit = async (data: any) => {
    const userId = Number(localStorage.getItem("adminId"));
    ...
    const response = await axios.put(
      `${process.env.REACT_APP_BACKEND_URL}court/edit/${userId}/${courtId}`,
      courtData
    );
    response.status === 200
            ...
            <div className="col-12 col-sm-12 col-md-12 col-lg-12">
              ...
              >
                                        ...
                                        <div className="duration-blk">
                                          ...
                                          <div className="form-icon">
                                            <TimePicker
                                              ...
                                              value={
                                                selectedHours.monday.startTime
                                                  ? dayjs(
                                        ...
                                        <div className="duration-blk">
                                          ...
                                          <div className="form-icon">
                                            <TimePicker
                                              ...
                                              value={
                                                selectedHours.tuesday.startTime
                                                  ? dayjs(
                                        ...
                                        <div className="duration-blk">
                                          ...
                                          <div className="form-icon">
                                            <TimePicker
                                              ...
                                              value={
                                                selectedHours.wednesday.endTime
                                                  ? dayjs(
                                                      selectedHours.wednesday
                                                        .endTime,
                                                      "HH:mm"
                                        ...
                                        <div className="duration-blk">
                                          ...
                                          <div className="form-icon">
                                            <TimePicker
                                              ...
                                              value={
                                                selectedHours.thursday.startTime
                                                  ? dayjs(
                                        ...
                                        <div className="duration-blk">
                                          ...
                                          <div className="form-icon">
                                            <TimePicker
                                              ...
                                              value={
                                                selectedHours.thursday.endTime
                                                  ? dayjs(
                                                      selectedHours.thursday
                                                        .endTime,
                                                      "HH:mm"
                                        ...
                                        <div className="duration-blk">
                                          ...
                                          <div className="form-icon">
                                            <TimePicker
                                              ...
                                              value={
                                                selectedHours.friday.startTime
                                                  ? dayjs(
                                        ...
                                        <div className="duration-blk">
                                          ...
                                          <div className="form-icon">
                                            <TimePicker
                                              ...
                                              value={
                                                selectedHours.saturday.startTime
                                                  ? dayjs(
                                        ...
                                        <div className="duration-blk">
                                          ...
                                          <div className="form-icon">
                                            <TimePicker
                                              ...
                                              value={
                                                selectedHours.saturday.endTime
                                                  ? dayjs(
                                                      selectedHours.saturday
                                                        .endTime,
                                                      "HH:mm"
                                        ...
                                        <div className="duration-blk">
                                          ...
                                          <div className="form-icon">
                                            <TimePicker
                                              ...
                                              value={
                                                selectedHours.sunday.startTime
                                                  ? dayjs(
                        ...
                        <div className="col-12">
                          <div className="">
                            ...
                            <Controller
                              name="venueOverview"
                              control={control}
                              rules={{ required: "Venue Overview is required" }}
                              render={({ field }) => (
                                <ReactQuill
                                  {...field}
                ...
                <button className="text-center btn-row btn btn-secondary save-profile">
                  Edit Court <i className="feather-arrow-right-circle ms-1" />
                </button>
              </form>
              {/* Accordian Contents */}
            </div>
